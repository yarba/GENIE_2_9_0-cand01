...
\class    genie::tune::GFitterMinuit2

\brief    A minuit2-based GENIE fitter
...
#ifndef _genie_fitter_minuit2_h_
#define _genie_fitter_minuit2_h_
...
class GFitterMinuit2: public GFitterABC
{
public:
   GFitterMinuit2();
   virtual ~GFitterMinuit2();
